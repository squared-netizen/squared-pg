---
title: {{PROJECT_TITLE}} Graphics2D
tags:
  - cpp
  - graphics
  - opengl-es
...
The generated application renders through the `squared::` C++ framework over
...
- `squared::graphics::Context` owns the window, context, viewport, clear, and
