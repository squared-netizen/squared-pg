...
EngineConfig config() {
    EngineConfig cfg;
    cfg.resource_roots.emplace_back(std::string{SQUARED_PG_TEST_SOURCE_DIR} + "/resources/templates");
    cfg.resource_roots.emplace_back(std::string{SQUARED_PG_TEST_SOURCE_DIR} + "/resources/kits");
    return cfg;
}
